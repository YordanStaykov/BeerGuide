...
export default function RecipeAddForm({ history }) {
		...
		<>
			<form onSubmit={onRecipeAddFormSubmitHandler}>
				<div className={style.container}>
					...
					<input
						type="text"
						placeholder="Enter Boiling Time"
						name="boilTime"
						id="boilTime"
						required
					/>
